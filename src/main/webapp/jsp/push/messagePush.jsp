...
<body lang="en" style="padding:0; margin:0;">
	...
	<script language="JavaScript" type="text/javascript">
		    ...
		    var on_connect = function(x) {
		        id = client.subscribe(queueName, function(m) {
		        	...
		        	if(type == "S") {
		        		...
		        		mesgResult += "<div class='inner_box'>";
		        		mesgResult += "<p class='name' id='receiverId' onClick='fn_targetUser(this);''>" + senderInfo + "</p>";
		        	}
		 ...
		 * 송신자 클릭시 이벤트 함수.
		 */
		function fn_targetUser(e) {
			var userInfo 	= $(e).text();
			var selectVal 	= $("#first form option:selected").val();
			var addMesg 	= "<option>" + userInfo + "</option>";
			var check 		= 0;
			...
			$("#selectBox option").each(function()
			{
			    ...
			    if(val == userInfo) {
			    	check ++;
			    	$("#selectBox").val(userInfo).attr("selected", "selected");
			    	return;
			    }
			});
