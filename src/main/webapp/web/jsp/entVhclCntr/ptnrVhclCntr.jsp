...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/web/jsp/entVhclCntr/css/ptnrVhclCntr.css" />
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/web/jsp/entVhclCntr/js/ptnrVhclCntr.js"></script>
</head>
<body>
