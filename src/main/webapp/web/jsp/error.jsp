...
<div class="box-pmCms">
	...
	<div class="common-error">
		<div class="inner">
			...
			<h1 class="logo"><a href="/ko/main"></a></h1>
			...
			<div class="common-boxLineType-1">
				...
				<dl class="list-1">
					<dt>요청하신 페이지를 찾을 수 없습니다.</span></dt>
					<dd>페이지의 주소가 잘못 입력되었거나, 주소가 변경 혹은 삭제되어<br/>요청하신 페이지를 찾을 수 없습니다.<br>
						<!--<a href="/ko/support" style="color:#666;"><strong>[고객지원 바로가기]</strong></a> -->
					</dd>
				</dl>
				<p class="btn-1">
					<span class="common-btnType-1">
						<a href="/gwds/index.jsp">홈으로</a>
						<!-- //171013 텍스트 수정 -->
