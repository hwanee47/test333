...
<div class="container">
	<!-- content -->
	<div class="content">
		<h2 class="s_tit">회원가입 안내</h2>

		<div class="sub_inner_ty01">
			<!-- tab-->
			<div class="tab_join01">
				<ul>
					<li><a href="join01_01.jsp" class="tb_01">화주</a></li>
					<li><a href="join01_02.jsp" class="tb_02">주선가맹점</a></li>
					<li><a href="join01_03.jsp" class="tb_03 on">운송가맹점</a></li>
					<li class="last"><a href="join01_04.jsp" class="tb_04">차주</a></li>
				</ul>
			</div>
			<!-- //tab-->
			...
			<div class="step_box step00">
				<ul>
					<li class="line1">가입신청 및 전화상담</li>
					<li>가입 구비서류 FAX<br/>또는 우편 제출</li>
					<li>가입승인 및<br/>서류 보완 요청</li>
					<li>가입완료 후<br/>CJ대한통운 화물정보망 이용</li>
				</ul>
			</div>

			<div class="join_cont01">
				<ul>
					<li>
						<div class="in_bx">
							<div class="bx_tx01">
								CJ대한통운 화물정보망 홈페이지<br/>
								에서 고객/가맹점 가입 신청을 통한<br/>
								화주 고객 신청이 가능합니다.
							</div>
							<div class="bx_bt01">
								<a href="#" class="btn_goto">회원가입 바로가기<span class="line"></span></a>
							</div>
							<div class="bx_tx01" style="margin-top:25px;">
								가까운 CJ대한통운 지점이나<br/>
								화물정보센터 전화를 통하여도 가입이<br/>
								가능합니다.<br/><br/>

								<span class="tx_blue">화물정보센터 : 1855-1234</span>
							</div>
						</div>
					</li>
					<li>
						<div class="in_bx">
							<div class="bx_tx01">
								구비 서류를 FAX, 우편, 이메일<br/>
								(스캔파일) 중 원하시는 방법으로<br/>
								제출하시면 됩니다
							</div>
							<div class="bx_tx02">
								<p><span class="tx_blue">*</span> 구비서류</p>
								1. 가입신청서<a href="#" class="btn_down">다운로드<span class="line"></span></a><br/>
								2. 사업자등록증<br/>
								3. 운전면허증<br/>
								4. 자동차등록증<br/>
								5. 적재물보험가입증<br/>
							...
							<div class="bx_tx01" style="margin-top:15px;">
								<span class="in_s_ti">제출방법</span><br/>
								FAX, 우편 또는 메일(스캔파일) 제출<br/>

								<span class="in_s_ti">주소</span><br/>
								서울특별시 중구 세종대로 9길 53<br/>
								(서소문동, 대한통운빌딩)<br/>
								CJ대한통운 3층<br/>
								HELLO 화물정보망사업 담당자 앞<br/>

								<span class="in_s_ti">팩스</span><br/>
								02-771-9258<br/>

								<span class="in_s_ti">이메일</span><br/>
								QQQ@SDF.COM
							</div>
						</div>
					</li>
					<li>
						<div class="in_bx">
							<div class="bx_tx01">
								제출하신 서류를 최대한 빠른 시간에<br/>
								확인을 하며, 가입승인을 합니다.<br/><br/>

								제출하신 서류 중, 확인이 안되거나<br/>
								보완해야 할 서류가 있다면 담당자가<br/>
								연락을 드릴 수 있습니다.
							</div>
						</div>
					</li>
					<li>
						<div class="in_bx">
							<div class="bx_tx01">
								이용 시, 건의/문의 사항은 언제든지<br/>
								<span class="tx_blue">화물정보센터 1855-1234</span>을 통하여<br/>
								문의하여 주시기 바랍니다
							</div>
						</div>
					</li>
