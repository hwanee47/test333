...
; MyAppName is to put key(MiUpdater KEY NAME) name
#define MyAppName      "대한통운 화물정보망 배차예술화"       ; 프로젝트 이름
#define MyAppVerName   "nexacro17All_inno"                    ; 버전 정보명
#define MyAppPublisher "TobeSoft"
#define MyAppURL       "http://support.tobesoft.co.kr/Support/index.html"
; MyAppExeName is exe file's name
#define MyAppExeName   "NKFR - Nexacro Runtime(x64) 2018.10.18"; 프로그램 등록 명
#define MyAppVersion   "17.0.0.1220"                          ; 버전 정보

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same  value in installers for other applications.
;(To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppID={{DB2D4086-A192-4FCB-A24D-77A7373B02AA}
AppName={#MyAppName}
...
;Program UnInstall List Name
UninstallDisplayName={#MyAppExeName}
VersionInfoVersion={#MyAppVersion}
VersionInfoCompany=TobeSoft
VersionInfoDescription=nexacro platform
VersionInfoTextVersion={#MyAppVersion}
VersionInfoCopyright=TobeSoft
VersionInfoProductName=nexacro platform
...
[Files]
Source: engine\*;        DestDir: {tmp};                Flags: ignoreversion deleteafterinstall
Source: img\loading.gif; DestDir: {code:componentPath}; Flags: ignoreversion recursesubdirs createallsubdirs
;Source: Launcher\*; DestDir: {tmp}; Flags: ignoreversion deleteafterinstall
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Run]
Filename: "{tmp}\TPLSvc_Setup.exe";                 Parameters: " /silent"; Flags: waituntilterminated postinstall shellexec runascurrentuser
Filename: "{tmp}\nexacro17_SetupRunTime_x64.exe";   Parameters: " /silent"; Flags: waituntilterminated postinstall shellexec runascurrentuser

[InstallDelete]
Type: filesandordirs; Name: "{tmp}\TPLSvc_Setup.exe" 
Type: filesandordirs; Name: "{tmp}\nexacro17_SetupRuntime_x64.exe"
;Type: filesandordirs; Name: "{code:enginePath}\*.*"
;Type: filesandordirs; Name: "{code:systemPath}\nexacrolauncherax14.dll"

[UninstallRun]
; Uninstall Execute
;Filename: "{sys}\msiexec.exe"; Parameters: "/x {{212D7517-F389-406B-99CF-9AB3B35B428D} /quiet /qb"
Filename: "{pf32}\TPLSvc\unins000.exe";
Filename: "{pf64}\nexacro\17\nexacro17_Uninstaller.exe"; 
...
// 캐쉬폴더 경로 
function cachFolderPath(Param: String): String;
var
...
begin
  ...
  begin
     Result := ExpandConstant('{userappdata}\..\LocalLow\nexacro\');
  end
  else     // XP 이하
  begin
     Result := ExpandConstant('{userappdata}\..\Local Settings\Compatible LocalLow\nexacro\');
  end
end;

// 컴포넌트 경로
function componentPath(Param: String): String;
var
  Version: TWindowsVersion;
begin
  GetWindowsVersionEx(Version)
