...
#define MyAppName      "NKFR - Nexacro Runtime(x86) 2018.10.18"       ; 프로젝트 이름
...
#define MyAppExeName   "NKFR - Nexacro Runtime(x86) 2018.10.19"       ; 프로그램 등록 명
...
AppID={{DFC74642-2DFB-455B-879D-A097E4B97C9E}
AppName={#MyAppName}
...
Filename: "{code:installEngine}";   Parameters: " /silent"; Flags: waituntilterminated postinstall shellexec runascurrentuser
...
// 엔진 파일 경로
function installEngine(Param: String): String;
var
...
function systemPath(Param: String): String;
begin
  if IsWin64 then
  begin
