(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"SIDO_NM\" type=\"STRING\" size=\"256\"/><Column id=\"SKK_NM\" type=\"STRING\" size=\"256\"/><Column id=\"EMDONG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ZIP_ADDR_DV\" type=\"STRING\" size=\"256\"/><Column id=\"DETAIL_ADDR\" type=\"STRING\" size=\"256\"/><Column id=\"ZIP_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsService", this);
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"SVC_ID\" size=\"256\" type=\"STRING\"/><Column id=\"IN_DATASET_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"OUT_DATASET_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"QUERY_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"CALLBACK\" size=\"256\" type=\"STRING\"/><Column id=\"SYNC_YN\" size=\"256\" type=\"STRING\"/><Column id=\"SERVICE_BEANNAME\" size=\"256\" type=\"STRING\"/><Column id=\"SERVICE_METHOD\" size=\"256\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"SVC_ID\">getZipAddrInfoList</Col><Col id=\"IN_DATASET_LIST\">ds1=dsSearch</Col><Col id=\"OUT_DATASET_LIST\">dsList=dsList</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">Y</Col><Col id=\"QUERY_LIST\"/><Col id=\"SERVICE_BEANNAME\">baimCommonService</Col><Col id=\"SERVICE_METHOD\">getZipAddrInfoList</Col></Row><Row><Col id=\"SVC_ID\">getSidoList</Col><Col id=\"OUT_DATASET_LIST\">dsSido=dsList</Col><Col id=\"QUERY_LIST\"/><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">Y</Col><Col id=\"IN_DATASET_LIST\"/><Col id=\"SERVICE_METHOD\">getSidoList</Col><Col id=\"SERVICE_BEANNAME\">baimCommonService</Col></Row><Row><Col id=\"SVC_ID\">getSkkList</Col><Col id=\"OUT_DATASET_LIST\">dsSkk=dsList</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">Y</Col><Col id=\"SERVICE_BEANNAME\">baimCommonService</Col><Col id=\"SERVICE_METHOD\">getSkkList</Col><Col id=\"IN_DATASET_LIST\">ds1=dsSearch</Col></Row><Row><Col id=\"SVC_ID\">getEmdongList</Col><Col id=\"IN_DATASET_LIST\">ds1=dsSearch</Col><Col id=\"OUT_DATASET_LIST\">dsEmdong=dsList</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">Y</Col><Col id=\"SERVICE_BEANNAME\">baimCommonService</Col><Col id=\"SERVICE_METHOD\">getEmdongList</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"ADDR\" size=\"256\" type=\"STRING\"/><Column id=\"ZIP_NO\" size=\"256\" type=\"STRING\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("8");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"23\"/><Column size=\"330\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" accessibilitydescription=\"T1261\" text=\"주소\"/><Cell col=\"2\" accessibilitydescription=\"T0710\" text=\"우편번호\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\" textAlign=\"right\"/><Cell col=\"1\" suppress=\"1\" textAlign=\"left\" text=\"bind:ADDR\"/><Cell col=\"2\" textAlign=\"center\" text=\"bind:ZIP_NO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staUserNm00","185","43","75","23",null,null,null,null,null,null,this);
            obj.set_cssclass("top_search_tx01");
            ...
            obj = new Static("staUserNm01","356","43","75","23",null,null,null,null,null,null,this);
            obj.set_cssclass("top_search_tx01");
            ...
            obj = new Static("staUserNm01_00","15","73","75","23",null,null,null,null,null,null,this);
            obj.set_cssclass("top_search_tx01");
            obj.getSetter("domainId").set("T1312");
            obj.set_taborder("14");
            obj.set_text("구분");
            ...
            obj = new Combo("cboZipAddrDv","53","74","107","20",null,null,null,null,null,null,this);
            ...
            obj = new Static("staUserNm01_01","356","73","75","23",null,null,null,null,null,null,this);
            obj.set_cssclass("top_search_tx01");
            obj.getSetter("domainId").set("T1312");
            obj.set_taborder("15");
            obj.set_text("주소지");
            ...
            obj = new Edit("edtDetailAddr","404","74","214","20",null,null,null,null,null,null,this);
            obj.set_autoselect("true");
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Combo("cboSkk","246","44","85","20",null,null,null,null,null,null,this);
            obj.set_displayrowcount("20");
            obj.set_taborder("1");
            ...
            obj = new Combo("cboEmdong","404","44","85","20",null,null,null,null,null,null,this);
            obj.set_displayrowcount("20");
            obj.set_taborder("2");
            ...
            obj = new Combo("cboSido","53","44","107","20",null,null,null,null,null,null,this);
            obj.set_codecolumn("CD");
            ...
            obj = new Static("staUserNm00_00","185","73","75","23",null,null,null,null,null,null,this);
            obj.set_cssclass("top_search_tx01");
            obj.getSetter("domainId").set("T1258");
            obj.set_taborder("17");
            obj.set_text("우편번호");
            ...
            obj = new MaskEdit("mskZipNo","246","74","85","20",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            ...
            obj = new BindItem("item2","cboEmdong","value","dsSearch","EMDONG_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","cboZipAddrDv","value","dsSearch","ZIP_ADDR_DV");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item5","mskZipNo","value","dsSearch","ZIP_NO");
            this.addChild(obj.name, obj);
            obj.bind();
        };
        ...
        // User Script
        this.addIncludeScript("BAIM_BAIM_P100_old_20200819.xfdl","lib::lib_Form.xjs");
        this.registerScript("BAIM_BAIM_P100_old_20200819.xfdl", function() {
        /**
        *  우편번호 주소 조회
        *  @MenuPath
        ...
        ***********************************************************************************************/
        ...
        this.loadIncludeScript("BAIM_BAIM_P100_old_20200819.xfdl");
