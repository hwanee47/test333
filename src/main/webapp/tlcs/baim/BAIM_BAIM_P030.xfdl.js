(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CUST_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_MGMT_DLCM_CD\" size=\"256\" type=\"STRING\"/><Column id=\"CUST_MGMT_DLCM_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CUST_MGMT_DLCM_CD\" size=\"256\" type=\"STRING\"/><Column id=\"CUST_MGMT_DLCM_NM\" size=\"256\" type=\"STRING\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsService", this);
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"SVC_ID\" size=\"256\" type=\"STRING\"/><Column id=\"IN_DATASET_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"OUT_DATASET_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"QUERY_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"CALLBACK\" size=\"256\" type=\"STRING\"/><Column id=\"SYNC_YN\" size=\"256\" type=\"STRING\"/><Column id=\"SERVICE_BEANNAME\" size=\"256\" type=\"STRING\"/><Column id=\"SERVICE_METHOD\" size=\"256\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"SVC_ID\">commonCode</Col><Col id=\"OUT_DATASET_LIST\">dsCpDv=ds1</Col><Col id=\"QUERY_LIST\">q1=MS005</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">N</Col><Col id=\"SERVICE_BEANNAME\">baimCommonService</Col><Col id=\"SERVICE_METHOD\">getCommonCode</Col></Row><Row><Col id=\"SVC_ID\">getCustMgmtDlcmInfoList</Col><Col id=\"IN_DATASET_LIST\">ds1=dsSearch</Col><Col id=\"SYNC_YN\">Y</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"OUT_DATASET_LIST\">dsList=ds1</Col><Col id=\"QUERY_LIST\">q1=baimSendCustMgmtService.getCustMgmtDlcmInfoList</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staUserNm00","315","43","66","23",null,null,null,null,null,null,this);
            ...
            obj = new Edit("edtCustMgmtDlcmCd_sc","385","44","100","20",null,null,null,null,null,null,this);
            ...
            obj = new Static("staUserNm00_00","503","42","66","23",null,null,null,null,null,null,this);
            obj.set_cssclass("top_search_tx01");
            obj.getSetter("domainId").set("T0617");
            obj.set_taborder("6");
            obj.set_text("협력사명");
            ...
            obj = new Edit("edtCustMgmtDlcmNm_sc","561","43","139","20",null,null,null,null,null,null,this);
            obj.set_cssclass("inp_ty01");
            obj.set_enable("true");
            obj.set_taborder("7");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtCustNm_sc","176","42","124","23",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_enable("false");
            obj.set_cssclass("inp_ty01");
            this.addChild(obj.name, obj);

            obj = new Edit("edtCustId_sc","74","42","100","23",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_cssclass("inp_ty01");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","edtCustMgmtDlcmCd_sc","value","dsSearch","CUST_MGMT_DLCM_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","edtCustMgmtDlcmNm_sc","value","dsSearch","CUST_MGMT_DLCM_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("BAIM_BAIM_P030.xfdl","lib::lib_Form.xjs");
        this.registerScript("BAIM_BAIM_P030.xfdl", function() {
        /**
        *  기업고객 조회 팝업
        *  @MenuPath
        ...
        * FORM EVENT 영역(onload)
        ...
        this.fnInit = function(obj,e)
        {
        	...
        	this.dsSearch.setColumn(0, "CUST_MGMT_DLCM_NM", this.getOwnerFrame().pCustMgmtDlcmNm);


        	// 협력사명 포커스
        	this.edtCustMgmtDlcmNm_sc.setFocus();
        };
        ...
        */
        ...
        {
        	var edtCustMgmtDlcmCd_scValue = this.edtCustMgmtDlcmCd_sc.value;	// 협력사코드
        	var edtCustMgmtDlcmNm_scValue = this.edtCustMgmtDlcmNm_sc.value;	// 협력사명

        	/** 조회조건 필수입력 체크********************************************************/
        	/*if( this.gfnIsNull(edtCustMgmtDlcmCd_scValue) && this.gfnIsNull(edtCustMgmtDlcmNm_scValue) ){
        		this.gfnAlert("협력사코드 또는 협력사명 입력해주세요.");

        		if( this.gfnIsNull(edtCustMgmtDlcmCd_scValue) ){
        			this.edtCustMgmtDlcmCd_sc.setFocus();
        			return;
        		}
        	...
        	this.gfnTransaction("getCustMgmtDlcmInfoList");
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtCustMgmtDlcmCd_sc.addEventHandler("onkeydown",this.Edit_onkeydown,this);
            this.edtCustMgmtDlcmNm_sc.addEventHandler("onkeydown",this.Edit_onkeydown,this);
        ...
        this.loadIncludeScript("BAIM_BAIM_P030.xfdl");
