(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtFileName","80",null,"386","24",null,"10",null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Button("btnxlsUpld","469",null,"90","23",null,"11",null,null,null,null,this);
            ...
            obj = new Static("stTitle00_00_00","10",null,"71","31",null,"36",null,null,null,null,this);
            obj.set_cssclass("in_tit01");
            obj.getSetter("domainId").set("T0198");
            obj.set_taborder("23");
            obj.set_text("양식선택");
            ...
            obj = new Edit("edtXlsFormNm","80",null,"386","24",null,"38",null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Button("btnXlsLayout","469",null,"90","23",null,"38",null,null,null,null,this);
            obj.set_cssclass("btn_ty04");
            ...
            obj = new Edit("edtFileUrl","565","766","265","23",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_cssclass("inp_ty01");
            obj.set_inputmode("upper");
            obj.set_enable("true");
            ...
            obj = new BindItem("item5","edtFileUrl","value","dsFileUrl","URL");
            this.addChild(obj.name, obj);
            obj.bind();
        };
        ...
        // User Script
        this.addIncludeScript("RCPT_ORDER_0001.xfdl","lib::lib_Form.xjs");
        this.registerScript("RCPT_ORDER_0001.xfdl", function() {
        /************************************************************************************************
        * include 선언부																				*
         ************************************************************************************************/
        ...
        ***********************************************************************************************/
        ...
        this.loadIncludeScript("RCPT_ORDER_0001.xfdl");
