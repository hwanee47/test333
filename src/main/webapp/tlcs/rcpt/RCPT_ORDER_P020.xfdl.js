(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdCustom","22","151","378",null,null,"30",null,null,null,null,this);
            ...
            obj = new Static("stTitle00","22","110","100","50",null,null,null,null,null,null,this);
            ...
            obj = new Static("sta02","356","132","43","16",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("선택");
            ...
            obj = new Static("sta02_00","313","132","43","16",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("필수");
            ...
            obj = new Button("btnExcelDownload","321","76","102","23",null,null,null,null,null,null,this);
        ...
        // User Script
        this.addIncludeScript("RCPT_ORDER_P020.xfdl","lib::lib_Form.xjs");
        this.registerScript("RCPT_ORDER_P020.xfdl", function() {
        /**
        *  주문접수 엑셀 양식 변경
        *  @MenuPath
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnExcelDownload.addEventHandler("onclick",this.btnOnClick,this);
        };

        this.loadIncludeScript("RCPT_ORDER_P020.xfdl");
