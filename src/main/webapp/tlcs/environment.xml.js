if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("extPrototype", "js", "./nexacro17lib/component/extPrototype/", "none", null, "", "0", "0");
        nexacro._addService("lib", "js", "./lib/", "none", null, "", "0", "0");
        nexacro._addService("frame", "form", "./frame/", "none", null, "", "0", "0");
        nexacro._addService("cmm", "form", "./cmm/", "none", null, "", "0", "0");
        nexacro._addService("svcurl", "JSP", "http://localhost:8080/TLCS/", "none", null, "", "0", "0");
        nexacro._addService("sample", "form", "./sample/", "none", null, "", "0", "0");
        nexacro._addService("img", "file", "./img/", "none", null, "", "0", "0");
        nexacro._addService("mdm", "form", "./mdm/", "none", null, "", "0", "0");
        nexacro._addService("css", "file", "./css/", "none", null, "", "0", "0");
        nexacro._addService("baim", "form", "./baim/", "none", null, "", "0", "0");
        nexacro._addService("dlvy", "form", "./dlvy/", "none", null, "", "0", "0");
        nexacro._addService("rcpt", "form", "./rcpt/", "none", null, "", "0", "0");
        nexacro._addService("whib", "form", "./whib/", "none", null, "", "0", "0");
        nexacro._addService("stck", "form", "./stck/", "none", null, "", "0", "0");
        nexacro._addService("whob", "form", "./whob/", "none", null, "", "0", "0");
        nexacro._addService("rcptpay", "form", "./rcptpay/", "none", null, "", "0", "0");
        nexacro._addService("board", "form", "./board/", "none", null, "", "0", "0");
        nexacro._addService("syst", "form", "./syst/", "none", null, "", "0", "0");
        ...
        var registerclass = [
        		...
        		{"id":"ICAPI", "classname":"nexacro.ICAPI", "type":"JavaScript"}
        ];
