(function()
{
    return function()
    {
        ...
        {
            this.set_name("RCPTPAY_MGT_0002");
            this.set_titletext("일수불");
            ...
            obj._setContents("<ColumnInfo><Column id=\"SVC_ID\" size=\"256\" type=\"STRING\"/><Column id=\"IN_DATASET_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"OUT_DATASET_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"QUERY_LIST\" size=\"256\" type=\"STRING\"/><Column id=\"CALLBACK\" size=\"256\" type=\"STRING\"/><Column id=\"SYNC_YN\" size=\"256\" type=\"STRING\"/><Column id=\"SERVICE_BEANNAME\" size=\"256\" type=\"STRING\"/><Column id=\"SERVICE_METHOD\" size=\"256\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"SVC_ID\">commonCode</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">N</Col><Col id=\"SERVICE_BEANNAME\">baimCommonService</Col><Col id=\"SERVICE_METHOD\">getCommonCode</Col><Col id=\"OUT_DATASET_LIST\">dsCpDv=ds1</Col><Col id=\"QUERY_LIST\">q1=MS005</Col></Row><Row><Col id=\"SVC_ID\">selectRcptpayByDay</Col><Col id=\"IN_DATASET_LIST\">dsSearch=dsSearch</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">Y</Col><Col id=\"OUT_DATASET_LIST\">dsList=dsResult dsListSum=dsSumResult</Col><Col id=\"SERVICE_BEANNAME\">rcptpayMgmtService</Col><Col id=\"SERVICE_METHOD\">selectRcptpayByDay</Col><Col id=\"QUERY_LIST\"/></Row><Row><Col id=\"SVC_ID\">saveRcptpayByDay</Col><Col id=\"IN_DATASET_LIST\">dsSearch=dsSearch</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"SYNC_YN\">Y</Col><Col id=\"OUT_DATASET_LIST\">dsList=dsResult dsListSum=dsSumResult</Col><Col id=\"SERVICE_BEANNAME\">rcptpayMgmtService</Col><Col id=\"SERVICE_METHOD\">saveRcptpayByDay</Col><Col id=\"QUERY_LIST\"/></Row><Row><Col id=\"SVC_ID\">getCustInfo</Col><Col id=\"SERVICE_BEANNAME\"/><Col id=\"SERVICE_METHOD\"/><Col id=\"SYNC_YN\">Y</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"IN_DATASET_LIST\">ds1=dsSearch</Col><Col id=\"OUT_DATASET_LIST\">dsCustInfo=ds1</Col><Col id=\"QUERY_LIST\">q1=baimCommonService.getCustInfo</Col></Row><Row><Col id=\"SVC_ID\">getItemInfo</Col><Col id=\"SERVICE_BEANNAME\"/><Col id=\"SERVICE_METHOD\"/><Col id=\"SYNC_YN\">Y</Col><Col id=\"CALLBACK\">fnCallback</Col><Col id=\"IN_DATASET_LIST\">ds1=dsSearch</Col><Col id=\"OUT_DATASET_LIST\">dsItemInfo=ds1</Col><Col id=\"QUERY_LIST\">q1=baimCommonService.getItemInfo</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList", this);
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"WORK_YMD\" size=\"256\" type=\"STRING\"/><Column id=\"WAREH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"WRAEH_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ITEM_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ITEM_NM\" type=\"STRING\" size=\"256\"/><Column id=\"STC_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"WAREI_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"WAREO_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"TRANSACTION_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"REG_EMP_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DTIME\" type=\"STRING\" size=\"256\"/><Column id=\"MODI_EMP_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MODI_DTIME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsListSum", this);
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"PDAY_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"WAREI_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"WAREO_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"TRANSACTION_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"WMS_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"SUM_QTY\" type=\"STRING\" size=\"256\"/><Column id=\"GAP_QTY\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"STA_DT\" size=\"256\" type=\"STRING\"/><Column id=\"END_DT\" size=\"256\" type=\"STRING\"/><Column id=\"CUST_ID\" size=\"256\" type=\"STRING\"/><Column id=\"GDS_CD\" size=\"256\" type=\"STRING\"/><Column id=\"WAREH_CD\" size=\"256\" type=\"STRING\"/><Column id=\"CUST_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ITEM_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stSearch00","1","stSearch:3",null,"110","30",null,null,null,null,null,this);
            obj.set_cssclass("top_search_ty01");
            obj.set_taborder("12");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_Main","0","stSearch00:3",null,null,"30","0",null,null,null,null,this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"130\"/><Column size=\"80\"/><Column size=\"130\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"작업일자\"/><Cell col=\"2\" text=\"창고코드\"/><Cell col=\"3\" text=\"창고명\"/><Cell col=\"4\" text=\"고객코드\"/><Cell col=\"5\" text=\"고객명\"/><Cell col=\"6\" text=\"품목코드\"/><Cell col=\"7\" text=\"품목명\"/><Cell col=\"8\" text=\"재고수량\"/><Cell col=\"9\" text=\"입고수량\"/><Cell col=\"10\" text=\"출고수량\"/><Cell col=\"11\" text=\"조정수량\"/><Cell col=\"12\" text=\"입력자\"/><Cell col=\"13\" text=\"입력시간\"/><Cell col=\"14\" text=\"수정자\"/><Cell col=\"15\" text=\"수정시간\"/></Band><Band id=\"body\"><Cell expr=\"currow+1\"/><Cell col=\"1\" text=\"bind:WORK_YMD\" displaytype=\"date\"/><Cell col=\"2\" text=\"bind:WAREH_CD\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:WRAEH_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:CUST_ID\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:CUST_NM\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:ITEM_CD\" textAlign=\"left\"/><Cell col=\"7\" text=\"bind:ITEM_NM\" textAlign=\"left\"/><Cell col=\"8\" text=\"bind:STC_QTY\" textAlign=\"right\" displaytype=\"number\"/><Cell col=\"9\" text=\"bind:WAREI_QTY\" textAlign=\"right\" displaytype=\"number\"/><Cell col=\"10\" text=\"bind:WAREO_QTY\" textAlign=\"right\" displaytype=\"number\"/><Cell col=\"11\" text=\"bind:TRANSACTION_QTY\" textAlign=\"right\" displaytype=\"number\"/><Cell col=\"12\" text=\"bind:REG_EMP_ID\"/><Cell col=\"13\" text=\"bind:REG_DTIME\"/><Cell col=\"14\" text=\"bind:MODI_EMP_ID\"/><Cell col=\"15\" text=\"bind:MODI_DTIME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("calYmdFr_sc","452","44","127","23",null,null,null,null,null,null,this);
            obj.set_taborder("38");
            obj.set_cssclass("cal_ty02");
            this.addChild(obj.name, obj);

            obj = new Static("sta07_00","585","43","8","23",null,null,null,null,null,null,this);
            obj.set_taborder("39");
            obj.set_text("-");
            obj.set_color("white");
            this.addChild(obj.name, obj);

            obj = new Calendar("calYmdTo_sc","596","44","127","23",null,null,null,null,null,null,this);
            obj.set_taborder("40");
            obj.set_cssclass("cal_ty02");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","mskPdayQty","value","dsListSum","PDAY_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","mskPdayQty00","value","dsListSum","WAREI_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","mskPdayQty00_00","value","dsListSum","WAREO_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","mskPdayQty00_00_00","value","dsListSum","TRANSACTION_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","mskPdayQty00_00_00_00","value","dsListSum","SUM_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","mskPdayQty00_00_00_00_00","value","dsListSum","WMS_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","mskPdayQty00_00_00_00_00_00","value","dsListSum","GAP_QTY");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","edtCustNm_sc","value","dsSearch","CUST_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","edtItemNm_sc","value","dsSearch","ITEM_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","calYmdFr_sc","value","dsSearch","STA_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","calYmdTo_sc","value","dsSearch","END_DT");
            this.addChild(obj.name, obj);
            obj.bind();
        };
        ...
        // User Script
        this.addIncludeScript("RCPTPAY_MGT_0002.xfdl","lib::lib_Form.xjs");
        this.registerScript("RCPTPAY_MGT_0002.xfdl", function() {
        /************************************************************************************************
        * include 선언부																				*
         ************************************************************************************************/
        ...
        ***********************************************************************************************/
        ...
        this.loadIncludeScript("RCPTPAY_MGT_0002.xfdl");
